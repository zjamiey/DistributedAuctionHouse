...
public class AuctionHouse implements Runnable, AuctionHouseRemoteService{
    ...
    /**Gets the first item in the auction house
     * @return item object
     * */
    public Item getItem(){
    ...
    private void initialize(){
        ...
        AuctionHouseRemoteService thisServer;
        AuctionHouseRemoteService stub =null;
        try {
            System.out.println("making Auction House "+ID+"...");
            thisServer = this;
            stub = (AuctionHouseRemoteService)
    ...
    /**Called if registry already made, then just join to the current existing registry*/
    private void joinRegistry(AuctionHouseRemoteService stub){
        try {
    ...
    /**Gets the auction house info such as ID and auctions in string
     * @return String of AH info*/
    ...
    /**Check if there are bids going o* @return true if we can deregister, else return false*/
    ...
    /**Scans user input and respond, in this case we are only able
     *  to exit the program with it
     * */
    ...
    /**Main method of this function, uses command line argument to set up key settings
     * and makes the AuctionHouse thread and start running
     * */
    public static void main(String args[]) throws IOException {
        if(args.length >2) {
            ...
            auctionHouse.book = args[0];
            auctionHouse.bankIP = args[1];
